                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            {suggestedSliderPhotos.map((photo, idx) => (
                                <div key={idx} className="relative group rounded-lg overflow-hidden border border-violet-200 bg-white">
                                    ...
                                    />
                                    {/* Mobile: buttons below photo */}
                                    <div className="md:hidden p-2 bg-white border-t border-violet-200">
                                        <p className="text-xs text-muted-foreground text-center line-clamp-1 mb-2">{photo.reason}</p>
                                        <div className="flex gap-2 justify-center">
                                            <Button 
                                                size="sm" 
                                                ...
                                                data-testid={`button-approve-slider-mobile-${idx}`}
                                            >
                                            ...
                                            <Button 
                                                ...
                                                data-testid={`button-dismiss-slider-mobile-${idx}`}
                                            >
                                                <X className="w-4 h-4" />
                                            </Button>
                                        </div>
